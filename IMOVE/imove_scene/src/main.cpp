#ifndef IMOVE_SCENE_MAIN_H
#define IMOVE_SCENE_MAIN_H
...
#include "../../../game/src/gameEntities/turtle/Turtle.h"
...
int main(int argc, char *argv[]) {
    ...
    // Set the IMOVE_ACTIVE configuration to true to signify to the game logic that IMOVE specific cases have to be
    // activated.
    Variables::IMOVE_ACTIVE = true;
